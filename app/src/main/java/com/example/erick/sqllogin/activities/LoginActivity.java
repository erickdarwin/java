...
import com.example.erick.sqllogin.About;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText usuario = (EditText)findViewById(R.id.TextInputEditEmail);
    EditText pass = (EditText)findViewById(R.id.TextInputEditPassword);
